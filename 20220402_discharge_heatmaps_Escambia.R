...
plot(dis_mat2, xlab = "Month", ylab = "Year",
     breaks = c(-10000, -5000, 0, 10000, 30000),
     fmt.key="%.0f",
     main = "Discharge",
     col = mypallette)
...
#subset for just the year 2005-2021
include_years <- as.character(as.numeric(2005:2021))
e_dis_per20052020 <- dis_per2[include_years, ]
plot(e_dis_per20052020, xlab = "Month", ylab = "Year",
     breaks = c(-100, -50, -25, -10, 10, 50, 100, 150, 200, 250, 300, 350, 400, 450),
     main = "Escambia Discharge Deviation",
     axis.row = list(las = 2),
     col = colAll, na.col = "black")
